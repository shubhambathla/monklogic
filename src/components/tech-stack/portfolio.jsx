import portfolio_data from '@/src/data/tech-stack-data';
            ...
            <div className="portfolio-area pt-100 pb-90">
               <div className="container">
                  ...
                  <div className="row grid">
                    {items.map((item, i)  => 
                        <div key={i} className="col-xl-2 col-lg-3 col-md-3 col-sm-3 col-4  grid-item  cat1 cat4 cat3 cat5">
                            ...
                            <div className="inner-project-content">
                                ...
                                <h4 className="inner-project-stacktitle"><Link href="/project-details">{item.title}</Link></h4>
                                {/* <p>{item.des}</p> */}
                            </div>
                            </div>
                        </div>
