...
const cta_content ={ 
     ...
     description: <>Unlock global business expansion through our comprehensive software development solutions – Empowering you with the tools to innovate, scale, and thrive in any corner of the world.</>,
                     ...
                     <div className="col-12">
                        <div className="tp-cta-bg" style={{backgroundImage: `url(${bg_img})`}}>
                           <div className="tp-cta-content tp-inner-font text-center">
                              ...
                              <p>{description}</p>
                                 <Link className="tp-btn-inner white-bg text-black" href="/service">{btn_text}</Link>
                           </div>
                        </div>
                     </div>
                  </div>
