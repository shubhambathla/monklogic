               ...
               <div className="container">
                  ...
                  <div className="row">
                    ...
                    {service_data.slice(0,6).map((item, i)  => 
                        <div key={i} className="col-xl-4 col-lg-4 col-md-6 col-6 mb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay={item.delay}>
                            <div className="tp-service__item mb-30">
                                <div className="tp-service__icon">
                                    <Image src={item.img} width={65} alt="theme-pure" />
                                </div>
                     ...
                     <div className="col-xl-4 col-lg-4 col-md-6 col-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                        <div className="tp-service__dashboard" 
                        style={{backgroundImage: `url(${bg_img})`}} >
                           <div className="tp-service__top-content">
                              <h3 className="tp-service__title-white">{title_2}</h3>
                              <p>{des}</p>
                              <Link className="tp-btn-orange tp-btn-hover alt-color-white" href="/tech-stack">
                                 <span>{btn_text}</span>
                                 <b></b>
                              </Link>
                           </div>
