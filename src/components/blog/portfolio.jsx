                  ...
                  <div className="row justify-content-center">
                     <div className="col-lg-8">
                        <div className="tp-about__section-box text-center mb-40">
                           <h4 className="inner-section-subtitle">OVER 100+ CLIENTS</h4>
                           <h3 className="tp-section-title">Accomplish more, Together</h3>
                           <p>MonkLogic blog is your knowledge center for everything remote.</p>
                        </div>
                     </div>
                  </div>
                  {/* <div className="row">
                        ...
                        <div key={i} data-index={i} className="col-xl-4 col-lg-6 col-md-6 mb-30 grid-item cat1 cat4 cat3 cat5">
                           <div className="tp-blog-item">
                              <div className="tp-blog-thumb fix">
                                 <Link href={item.href}><Image src={item.thumb_img} alt="theme-pure" /></Link>
                              </div>
