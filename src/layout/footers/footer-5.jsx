...
import footer_logo from "../../../public/assets/img/logo/monklogiclogo.png";


const footer_content = {
    info:"Build a modern and creative website with MonkLogic",
    phone: "+91 9837310900",
    email: "connect@monklogic.com",
    ...
    footer_lisks : [
        {
            ...
            delay: ".5s",
            links: [
                {name: "Web Designing", link: "/website-designing"},
                {name: "Web Development", link: "/website-development"},
                {name: "Crypto Solutions", link: "/crypto-solutions"},
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 pb-30  wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                           <div className={`tp-footer__widget ${style_team && "tp-footer__input-inner"} footer-widget-3 footer-col-3-1`}>  
                              <div className="tp-footer__logo mb-25">
                                 <Link href="/">
                                    <Image src={footer_logo} width={200} alt="" />
                                 </Link>
                              </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 pb-30  wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                           <div className="tp-footer__widget footer-widget-3 footer-widget-5 footer-col-3-4">
                              ...
                              <div className="tp-footer__social-3">
                                 ...
                                 <Link href="https://www.linkedin.com/company/monklogic"><i className="fab fa-linkedin-in"></i></Link>
