...
import about_img_2 from "../../public/assets/img/about/about-6.svg"
            ...
            <div className="tp-about__area tp-about__pt-pb pt-100 pb-160">
               <div className="container">
                  <div className="row align-items-center">
                     <div className="col-xl-6 col-lg-6 wow tpfadeLeft" data-wow-duration=".5s" data-wow-delay=".2s">
                     ...
                     <div className="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".5s" data-wow-delay=".2s">
                        <div className="tp-about__right">
                           ...
                           <div className="tp-about__btn">
                              <Link className="tp-btn tp-btn-hover alt-color-black" href="/service">
                                 <span>{btn_text}</span>
                                 <b></b>
                              </Link>
                           </div>
